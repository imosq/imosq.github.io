...
function initHashChange() {
	...
	if(hashVal == "auto-billing") {
		hashVal = "postpaid";
		$("#auto-billing").addClass("active");
		$("#auto-billing .toggle-ctnt").show();
	}
...
function initPromoBnr() {
    $('.promo-bnr-sect').each(function() {
		var sliderSpeed = $(this).attr("data-slider-speed");
...
function structureRewardsContent(rewardsXMLData, category, location) {
    ...
    rewardList.each(function(n) {
        ...
        itemObj.imageLogo = '/images/rewards/' + itemObj.imageFolder + '/logo.png';
